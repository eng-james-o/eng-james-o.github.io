...
Airfm is built on a foundation of two powerful technologies: Qt/QML for the frontend, and Python for the backend. This combination allows for a clean separation of concerns, with each technology playing to its strengths.
...
Here's a quick look at some of the screens in Airfm, which showcase the application of these architectural principles:

* **Splash Screen:** The first thing you see, setting the stage for a professional and polished experience.
![Splash screen]({{ site.baseurl }}/assets/images/splash_screen.png)

* **Main Screen:** The central hub for interacting with airfoils, featuring an interactive plot and customizable settings.
![Main screen]({{ site.baseurl }}/assets/images/main_screen.png)

* **Select Project:** A simple and intuitive way to manage your projects and saved sessions.
![Select Project]({{ site.baseurl }}/assets/images/select_project.png)
...
---
**Thanks for reading!** If you're interested in learning more about Airfm, or if you'd like to contribute to the project, please visit the [GitHub repository](https://github.com/eng-james-o/Airfm).
